...
<body>
	<div class="login">
		<h1>用户名或密码错误</h1>
		<form action="<%=basePath %>jsp/login/login.jsp" method="post">
			<input type="text" name="username" placeholder="用户名" required="required" value="<%=userName%>" disabled="disabled"/>
			<input type="password" name="password" placeholder="密码" required="required" value="<%=passWord%>" disabled="disabled"/>
			<button type="submit" class="btn btn-primary btn-block btn-large">点击返回登陆</button>
		</form>
	</div>
</body>
